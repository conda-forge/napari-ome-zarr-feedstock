About napari-ome-zarr-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/napari-ome-zarr-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/napari-ome-zarr-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install napari-ome-zarr
```
...
It is possible to list all of the versions of `napari-ome-zarr` available on your platform:
...
```
pixi search napari-ome-zarr --channel conda-forge
```
